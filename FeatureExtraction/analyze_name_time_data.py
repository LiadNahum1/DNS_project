...
FILE_NAME_EXTRACTED = '../FileCenter/minimzed_data/dnsSummary_user'
...
def build_empty_dictionaries():
    file_all_user_chunks = open('../FileCenter/minimzed_data/all_user_chunks', 'rb')
    ...
    with open('../FileCenter/minimzed_data/all_users_hour_name_tuples', 'wb') as fp:
